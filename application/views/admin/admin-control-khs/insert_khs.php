            ...
            <div class="col-md-8 offset-2">
                <div class="card">
                    <div class="card-header">
                        <h3 class="text-center">Form Pengisian Khs Mahasiswa</h3>
                    </div>
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                        ...
                        <form method="post" id="form-khs">
                            <div class="form-group">
                                <input type="hidden" class="form-control" name="npm" id="npm" value="<?= $data_mhs['npm_mhs'] ?>">
                            </div>
                            <div class="form-group">
                                <input type="hidden" class="form-control" name="id_akademik" id="id_akademik" value="<?= $data_mhs['id_akademik'] ?>">
                            </div>
                            <div class="form-group">
                                <input type="hidden" class="form-control" name="semester" id="semester" value="<?= $data_mhs['semester'] ?>">
                            </div>
                            <?php $i = 1; ?>
                            <?php foreach ($data_matkul as $matkul) : ?>
                                <?php if ($matkul['semester'] == $data_mhs['semester'] && $matkul['id_akademik'] == $data_mhs['id_akademik']) : ?>
                                    <div class="form-group">
                                        <div class="label">
                                            <label><strong><?= $matkul['matkul'] ?></strong></label>
                                        </div>
                                        <input type="text" class="form-control" name="nilai<?= $i; ?>" id="nilai<?= $i; ?>">
                            ...
                            <button type="submit" class="btn btn-success float-right" id="insert-data">insert data khs</button>
                        </form>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#insert-data', function(e) {
                ...
                $.ajax({
                    url: "<?= site_url('admin_control_khs/insert_khs') ?>",
                    type: "post",
                    data: {
                        npm: npm,
